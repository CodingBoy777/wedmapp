...
function JSHL(langName){
    ...
    function hlbylanguage(html, lang, findParent){
        ...
        var //start = new Date(),
            ...
            type = ['doc','com','mrk','str','nxx','gxx','xxx','yxx','zxx','ixx','jxx','fxx','mxx','trig','pr','expression','num','operator','gerr','xerr','merr','var','obj','bol','ope'],
            //type = ['g-com','str','nxx','gxx','xxx','yxx','zxx','ixx','jxx','kxx','pr','expression','bracket','trig','operator','fxx','mxx','g-var','num'],
